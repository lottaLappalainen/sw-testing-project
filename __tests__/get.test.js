...
describe('get', () => {
  ...
  it('should handle non-string paths (numeric index)', () => {
    const obj = [42, { a: 100 }];
    expect(get(obj, 1)).toEqual({ a: 100 });
  });
  ...
  it('should work with deeply nested missing paths and a default value', () => {
    const obj = { a: { b: { c: { d: { e: 42 } } } } };
